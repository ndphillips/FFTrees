...
Here is the best training tree, when applied to the test dataset:
...
As we can see, this tree has both a sensitivity and a specificity of around\ $80$%, but does not perform as well as our earlier one. 
