...
As we will see, the `FFTrees()` function will accept this description (in its `my.tree` argument), create a corresponding FFT, and evaluate it on a corresponding dataset. 
