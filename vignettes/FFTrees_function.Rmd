...
This vignette starts by building a fast-and-frugal tree (FFT) from the `heartdisease` data ---\ also used in the [Heart Disease Tutorial](FFTrees_heart.html) and @phillips2017FFTrees\ --- but then explores additional aspects of the `FFTrees()` function. 
