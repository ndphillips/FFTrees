...
In our example, our selected FFT use the cues `thal`, `cp`, and\ `ca`, but we wanted to explore the alternative cue order `thal`, `ca`, and\ `cp`. In other words, we need to swap the order of the 2nd and 3rd\ cues of `fft_1`. 
...
For instance, to swap the order of the 2nd and 3rd nodes of `fft_1`, we use: 
