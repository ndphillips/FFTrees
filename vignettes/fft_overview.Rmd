...
The purpose of the `FFTrees` package is to produce, compare, and display FFTs. For example, the FFT below predicts whether a patient has breastcancer based on two cues:
