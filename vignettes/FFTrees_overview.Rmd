...
What is a Fast and Frugal Tree (FFT)? An FFT is a set of rules for making decisions based on very little information (usually 5 or fewer). For example, the tree above uses data from breast cancer patients to decide whether a woman truly has breast cancer or not based on only two pieces of information.
