...
What is a Fast and Frugal Tree (FFT)? An FFT is a set of rules for making decisions based on very little information (usually 1 to 5 pieces). For example, the tree above uses data from breast cancer patients to decide whether a woman truly has breast cancer or not based on only two pieces of information.
...
- [Creating FFTs with FFTrees)](FFTrees_function.html)
- [Visualizing FFTs with plot()](FFTrees_plot.html)
- [Lots of example FFTs](FFTrees_examples.html)
