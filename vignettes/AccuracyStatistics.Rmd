...
You'll notice a 2 x 2 table in the bottom-left hand side of the plot. This is a *2 x 2 Confusion Table* [Wikipedia Entry](https://en.wikipedia.org/wiki/Confusion_matrix). All accuracy measures can be derived from this table. Here is a generic version of a confusion table:
