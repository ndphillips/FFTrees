...
## Article in Judgment and Decision Making

- Phillips, N. D., Neth, H., Gaissmeier, W. & Woike, J. (in press). FFTrees: An R package to create, visualize, and implement fast-and-frugal decision trees. *Judgment and Decision Making*.

We have an article in press introducing the package in the journal [Judgment and Decision Making](http://www.sjdm.org/journal/). We encourage you to read the article to learn more about the history of FFTs and how the FFTrees package creates them.
