...
key_results <- data.frame(matrix(NA, nrow = 4, ncol = 4))
...
# Row 4: 100% NA values:
key_results[4, "pc_NA"]   <- 100
key_results[4, "mn_acc"]  <- mean(heart_NA_100$acc[-1])
key_results[4, "mn_bacc"] <- mean(heart_NA_100$bacc[-1])
key_results[4, "mn_mcu"]  <- mean(heart_NA_100$mcu[-1])
