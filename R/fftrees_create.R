...
fftrees_create <- function(data = NULL,
  ...
  if (goal == "cost" & is.null(goal.chase)) {
    ...
    if (quiet == FALSE) {
      message("Setting goal.chase = 'waccc'")
    }
  }
  ...
  x <- list(
    ...
    # model
    metadata = list(
      criterion_name = criterion_name, # Name of the criterion
    ...
    comp = list(
      lr = list(model = NULL, results = list(
        train = list(stats = NULL),
        test = list(stats = NULL)
      )),
      cart = list(model = NULL, results = list(
        train = list(stats = NULL),
        test = list(stats = NULL)
      )),
      rf = list(model = NULL, results = list(
        train = list(stats = NULL),
        test = list(stats = NULL)
      )),
      svm = list(model = NULL, results = list(
        train = list(stats = NULL),
        test = list(stats = NULL)
      ))
    )
