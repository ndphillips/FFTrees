...
|:------|:----|:---|
|     mfan|    Marginal Fan| @phillips2017FFTrees  |
|     cfan|    Conditional Fan|@phillips2017FFTrees|  
...
The default algorithm used to create trees `"mfan"` can be summarised in four steps. 
...
Table: 4 Steps in growing FFTs using the mfan algorithm.
