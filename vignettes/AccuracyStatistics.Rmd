...
In this vignette, we cover how accuracy statistics are calculated for FFTs and the **FFTrees** package. 
...
Now that we know where $mcu$ comes from, $pci$ is just as simple --- it's just the total number of cues in the dataset minus $mcu$, divided by the total number of cues in the data: 
...
For additional measures based on the frequency counts of a 2x2 matrix, see [Table 3](https://www.frontiersin.org/articles/10.3389/fpsyg.2020.567817/full#h5) of 
...
_Frontiers in Psychology_, _11_, 567817. doi: [10.3389/fpsyg.2020.567817](https://doi.org/10.3389/fpsyg.2020.567817)
