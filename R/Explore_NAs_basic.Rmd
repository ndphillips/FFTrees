...
# in total 100% = 150 values per row should be NAs in the end: 
per_row_100 <- nrow(heart.train)
...
plot(heart.fft_NA_100) # it shows the expected behaviour but the baseline for diseased.
