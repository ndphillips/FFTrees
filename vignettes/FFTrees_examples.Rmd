...
```{r fft-mushrooms-1-plot-cues, out.width = "450px"}
...
```{r iris-plot-cues, out.width = "450px"}
# Plot cue values: 
...
For example FFTs that predict people's survival of the _Titanic_ disaster (using the `titanic` data), see the [Visualizing FFTs](FFTrees_plot.html) vignette. 
