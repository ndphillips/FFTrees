...
It has nearly perfect _sensitivity_ (i.e., is good at identifying cases of _Disease_) but suffers from low _specificity_ (i.e., is not so good at identifying _Healthy_ cases). Overall, the _accuracy_ of our custom tree exceeds the data's baseline by a fair amount. However, exploring **FFTrees** further will quickly enable you to design much better FFTs.
