...
All statistics can be derived from a 2 x 2 confusion table like the one below. 
...
The following statistics require a bit more information than the confusion table:
