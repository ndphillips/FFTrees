...
```{r titanic-what-tree, fig.align = 'center', fig.height = 7, fig.width = 10, out.width = "75%", fig.cap="**Figure 3**: An FFT diagram with icon arrays on exit nodes."}
...
```{r titanic-train, fig.width = 6, fig.height = 6, fig.align='center', out.width = "75%", fig.cap="**Figure 6**: Plotting the best FFT on _training_ data."}
...
```{r titanic-test, fig.width = 6, fig.height = 6, fig.align='center', out.width = "75%", fig.cap="**Figure 7**: Plotting the best FFT on _test_ data."}
...
```{r titanic-viz-2, fig.width = 6, fig.height = 6, fig.align='center', out.width = "75%", fig.cap="**Figure 8**: Plotting Tree\ #2."} 
