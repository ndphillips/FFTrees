...
All statistics can be derived from a 2 x 2 confusion table like the one below. For definitions of all accuracy statistics, look at [Accuracy statistic definitions](AccuracyStatistics.html)
...
plot(heart.fft,              # An FFTrees object
     ...
     main = "Heart Disease") # Plot heading
```
