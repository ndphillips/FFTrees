...
# render the table from the dataframe
# use as many items per side as we have datasets
# redefine coloumn names as we like them
DT::datatable(combined_result, options = list(pageLength = 14),
              colnames = c(
    "Number of Cases" = "Cases_n",
    "Baseline in Percent" = "Baseline_pct",
